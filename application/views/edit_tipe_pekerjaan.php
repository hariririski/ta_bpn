  ...
  <?php echo $this->load->view('common/modal', '', TRUE);?>
                ...
                <div class="page-content-wrap">                
					...
					<?php
						...
						$i=0;
						foreach($edit_tipe_pekerjaan as $data){
						?>
						 <?php
							echo form_open('Redirect_controller/proses_edit_tipe_pekerjaan?id='.$data->id_tipe_pekerjaan.'', array('name' => 'myform'));    
						?>
										...
										<div class="form-group">
											...
											<div class="col-md-6 col-xs-12">                                            
												<div class="input-group">
													...
													<input type="text" class="form-control"/ required name="nama_pekerjaan" value="<?php echo $data->nama_tipe_pekerjaan; ?>">
												</div>                                            
