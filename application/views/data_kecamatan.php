                ...
                <div class="page-content-wrap">                
                    ...
                    <div class="row">
						...
						<?php echo $this->session->flashdata('pesan');?>
						 <?php
							echo form_open('Redirect_controller/proses_tambah_kecamatan', array('name' => 'myform'));    
						?>
									...
									<div class="panel-body">                                                                        
										...
										<div class="form-group">
											...
											<div class="col-md-6 col-xs-12">                                            
												...
												<span class="help-block">Contoh : Johan Pahlawan</span>
											</div>
										</div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">Tabel Kecamatan</h3>
                                    <ul class="panel-controls">
                                    ...
                                    <table class="table datatable">
                                        ...
                                        <tbody>
											...
											?>
												...
												<td><a href="<?php echo base_url()?>edit_kecamatan?id=<?php echo $data->id_kecamatan ?>" ><button type="button" class="btn btn-success">Edit</button></a></td>
												<?php
												echo"<td class='center'><a href='". base_url()."Redirect_controller/proses_hapus_kecamatan/".$data->id_kecamatan."' onclick=\"return confirm('Apakah Anda Yakin Menghapus ?') 
