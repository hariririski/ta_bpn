                ...
                <div class="page-content-wrap">                
                    ...
                    <div class="row">
                        <div class="col-md-12">
						 ...
						 <?php
							echo form_open('Redirect_controller/proses_tambah_desa', array('name' => 'myform'));    
						?>
										...
										<div class="form-group">
											...
											<div class="col-md-6 col-xs-12">                                            
												<div class="input-group">
													...
													<input type="text" class="form-control"/ required name="nama_desa">
												</div>                                            
												<span class="help-block">Contoh : Ateuk</span>
											</div>
										</div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">Tabel Desa</h3>
                                    <ul class="panel-controls">
                                    ...
                                    <table class="table datatable">
                                        ...
                                        <tbody>
											...
											?>
												...
												<td><a href="<?php echo base_url()?>edit_desa?id=<?php echo $data->id_desa ?>" ><button type="button" class="btn btn-success">Edit</button></a></td>
												<?php
												echo"<td class='center'><a href='". base_url()."Redirect_controller/proses_hapus_desa/".$data->id_desa."' onclick=\"return confirm('Apakah Anda Yakin Menghapus ?') 
