            ...
            <div class="page-content">
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
						...
						?>
                            <?php
							$link="Redirect_controller/proses_edit_tanah?id_tanah=$kode_pemohon&&id=$id";
							echo form_open($link, array('class' => 'form-horizontal'));    
						?>
                           
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Edit </strong> Tanah Pemohon</h3>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="number" class="form-control" value="<?php echo $data->luas?>" name="luas_tanah" required/>
                                            </div>                                            
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select class="form-control select" name="penggunaan_tanah" required>
                                               ...
                                               <?php if($data->penggunaan_tanah=="Pertanian"){?>
                                ...
                                <div class="panel-body">
                                    <table class="table datatable">
                                        ...
                                        <tbody>
											...
											<td><?php
												echo"<a href='". base_url()."Redirect_controller/proses_cetak_laporan/".$data->id_tanah."'><button type='button' class='btn btn-warning'>Edit</button></a>
																";
												?>
											</td>
											<td><?php
